...
import 'package:dev_mate/src/repository/authentication_repository/exception/signup_email_password_failure.dart';
...
class AuthenticationRepository extends GetxController {
  ...
  Future<bool> verifyOTP(String otp) async {
    var confirmation = await _auth.signInWithCredential(
        PhoneAuthProvider.credential(
            verificationId: verificationId.value, smsCode: otp));
    return confirmation.user != null ? true : false;
  }
